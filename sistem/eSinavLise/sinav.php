...
<title>Edremit Teknik ve Endüstri Meslek Lisesi E-Sınav Projesi - &#169; Musa Öğretir 2013</title>
...
<body>
	<div id="disCerceve">
            ...
            <div id="sol">
                    ...
                    <div id="s4">
                    	<?php
							$q = mysql_fetch_object(mysql_query("SELECT kullanicilar.ad,kullanicilar.soyad FROM sinavlar INNER JOIN kullanicilar ON kullanicilar.id = sinavlar.ogretmen WHERE sinavlar.id = '".$_SESSION["ogrenci"]["sinavID"]."'"));
...
<body>
	<div id="disCerceve" align="center">
                ...
                <?php
                    ...
                    $q3 = mysql_fetch_object(mysql_query("SELECT * FROM kullanicilar WHERE id = '".$q1->ogretmen."'"));
                    $q4 = mysql_fetch_object(mysql_query("SELECT dallar.dal FROM sinavlar INNER JOIN dallar ON sinavlar.dal = dallar.id WHERE sinavlar.id = '".$_SESSION['ogrenci']['sinavID']."'"));
                ...
                <div class="sinavBilgileri">
                    <div class="sutun">
                        ...
                        <div class="bilgi"><?php echo "<div class='soru'>ÖĞRETMEN : </div> <div class='cevap'>$q3->ad $q3->soyad</div>";?></div>
                    ...
                    <div class="sutun">
                        ...
                        <div class="bilgi"><?php echo "<div class='soru'>DAL : </div> <div class='cevap'>$q4->dal</div>";?></div>
