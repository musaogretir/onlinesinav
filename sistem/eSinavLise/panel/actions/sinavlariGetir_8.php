<?php
	...
	if ($_POST)
	{
		...
		if ($g)
		{
			$msg = '<select id="sinav_8" name="sinav_8">
                  <option value="0">Seçiniz</option>';
				  
			$q1 = mysql_query("SELECT * FROM sinavlar WHERE ogretimYili = (SELECT id FROM ogretimyili WHERE aktif = 1 ) AND donem='".$_SESSION["gecerliKullanici"]["dnm"]."' AND ogretmen = '".$_SESSION["gecerliKullanici"]["userId"]."' AND sinavTuru='$g' AND sinavSorulari ='' AND sinavDegerlendirmeDurumu = 0 ORDER BY id ASC");
