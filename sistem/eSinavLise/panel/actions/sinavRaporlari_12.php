	...
	if ($_POST){
		...
		while($al = mysql_fetch_object($q1)){
			...
			$yaz.=" <tr>
					...
					<tr>
						<td align='right'><b>Soru Sıralaması :</b></td><td colspan='2'>".siralama($al->soruSiralamasi)." </td>
					</tr>	
					<tr>
		...
		echo "<div class='temizle'></div>
			  <div align='center'>
			  		<input type='button' value='Yazdırma Ekranı' id='yazdirBtn_12' rel='".base64_encode(base64_encode($id))."'/>
			  </div>
			 ";
