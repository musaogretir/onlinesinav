...
<div id="altSayfaContainer">
    		<div class="altSayfaBolum">
            		<div class="altSayfaBaslikSeviye1">Ünvan Ekle : </div>
                    <div class="altSayfaFormAlani">     
                            <div class="altSayfaFormAlaniBilgiSatiri">
                            		<div class="altSayfaFormSoruAlani">Ünvan Adı : </div>
                                    <div class="altSayfaFormCevapAlani">
                                    	<input type="text" id="unvan" name="unvan"  />
                                    </div>
                                    <div class="altSayfaFormAciklamaAlani">Ünvan adını giriniz.</div>
                            </div>
                            <div class="altSayfaFormAlaniBilgiSatiri">
                    ...
                    <div class="altSayfaBaslikSeviye1">Mevcut Ünvan Listesi: </div>
                            <div class="altSayfaFormAlani">
                                    <div class="altSayfaFormAlaniBilgiSatiri">
                                    ...
                                    <div class="altSayfaFormAciklamaAlani">Silinecek ünvanı seçiniz.</div>
                            </div> 
                            <div class="altSayfaFormAlaniBilgiSatiri">
                            		<div class="altSayfaButonAlani">
                                    	<div class="btnOnay">
