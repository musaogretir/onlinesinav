...
<div id="altSayfaContainer">
    		<div class="altSayfaBolum">
            		<div class="altSayfaBaslikSeviye1">Bölüm Ekle : </div>
                    <div class="altSayfaFormAlani">     
                            <div class="altSayfaFormAlaniBilgiSatiri">
                            		<div class="altSayfaFormSoruAlani">Bölüm Adı : </div>
                                    <div class="altSayfaFormCevapAlani">
                                    	<input type="text" id="bolumAdi" name="bolumAdi"  />
                                    </div>
                                    <div class="altSayfaFormAciklamaAlani">Bölüm adını giriniz.</div>
                            </div>
                            <div class="altSayfaFormAlaniBilgiSatiri">
                    ...
                    <div class="altSayfaBaslikSeviye1">Mevcut Bölüm Listesi: </div>
                            <div class="altSayfaFormAlani">
                                    <div class="altSayfaFormAlaniBilgiSatiri">
                                    ...
                                    <div class="altSayfaFormAciklamaAlani">Silinecek bölümü seçiniz.</div>
                            </div> 
                            <div class="altSayfaFormAlaniBilgiSatiri">
                            		<div class="altSayfaButonAlani">
                                    	<div class="btnOnay">
