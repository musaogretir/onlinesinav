                                    ...
                                    <div class="altSayfaFormCevapAlani">
                                    	<select id="aktifDonem_34" name="aktifDonem_34">
                                                ...
                                                <?php
													...
													$q2 = mysql_fetch_object(mysql_query("SELECT * FROM donemler WHERE aktif = 1"));
													echo "<option value='$q1->id,$q2->id'>$q1->ogretimYili Öğretim Yılı $q2->donem.Dönem</option>";
												?>
                                        </select>
                                    </div>
