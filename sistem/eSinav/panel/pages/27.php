...
<div id="altSayfaContainer">
    		<div class="altSayfaBolum">
            		<div class="altSayfaBaslikSeviye1">Öğretim Türü Ekle : </div>
                    <div class="altSayfaFormAlani">     
                            <div class="altSayfaFormAlaniBilgiSatiri">
                                    ...
                                    <div class="altSayfaFormCevapAlani">
                                    	<input type="text" id="ogretimTuru" name="ogretimTuru"  />
                                    </div>
                                    <div class="altSayfaFormAciklamaAlani">Öğretim türünü giriniz.</div>
                            </div>
                            <div class="altSayfaFormAlaniBilgiSatiri">
                    ...
                    <div class="altSayfaBaslikSeviye1">Mevcut Öğretim Türleri Listesi: </div>
                            <div class="altSayfaFormAlani">
                                    <div class="altSayfaFormAlaniBilgiSatiri">
                                    ...
                                    <div class="altSayfaFormAciklamaAlani">Silinecek öğretim türünü seçiniz.</div>
                            </div> 
                            <div class="altSayfaFormAlaniBilgiSatiri">
                            		<div class="altSayfaButonAlani">
                                    	<div class="btnOnay">
