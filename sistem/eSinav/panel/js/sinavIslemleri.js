...
$(document).delegate("#sinav_8","change",function(){
	...
	var v = $(this).val();
	if (v>0){
		$.post('actions/soruTurleriniGetir_8.php',{a:v},function(data){$("#gizliBolum_8_1 .altSayfaFormCevapAlani").html(data);$('#gizliBolum_8_1').slideDown(500);$.unblockUI();});	
	}
});
...
$(document).delegate("#sinavTuru_9","change",function(){
	var v = $(this).val();
	if (v>0){
		$.post('actions/sinavlariGetir_9.php',{a:v},function(data){$("#gizliBolum_9 .altSayfaFormCevapAlani").html(data);$('#gizliBolum_9').slideDown(500);});	
	}
});
